...
const FramebufferProperties &VKFramebuffer::GetProperties() const {
    return Properties;
}

uint32_t VKFramebuffer::GetColorAttachmentRendererID() const {
    return 0;
}

uint32_t VKFramebuffer::GetDepthAttachmentRendererID() const {
    return 0;
}

const vk::DescriptorImageInfo &VKFramebuffer::GetNativeDescriptorInfo() const {
    return DescriptorImageInfo;
}

vk::Framebuffer VKFramebuffer::GetNativeFramebuffer() const {
    return Framebuffer;
}
