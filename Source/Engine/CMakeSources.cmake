...
list(APPEND OMNIA_HEADERS ${ENGINE_MATH_HEADERS})
list(APPEND OMNIA_SOURCES ${ENGINE_MATH_SOURCES})
...
# Utility
set(ENGINE_UTILITY_HEADERS
	"Ultra/Utility/ShaderCompiler.h"
)
set(ENGINE_UTILITY_SOURCES
	"Ultra/Utility/ShaderCompiler.cpp"
)
list(APPEND ENGINE_HEADERS ${ENGINE_UTILITY_HEADERS})
list(APPEND ENGINE_SOURCES ${ENGINE_UTILITY_SOURCES})
