...
public:
	...
	void Draw(const std::string &title, bool *p_open) {
		...
		if (!ImGui::Begin(title.c_str() , p_open)) { ImGui::End(); return; }
		...
		ImGui::SameLine(ImGui::GetWindowWidth() -192.0f);
		Filter.Draw("", 180);
		ImGui::Separator();
...
static void ShowExampleAppConsole(bool *p_open) {
	...
	//static ConsoleView console2;
	//console2.Draw("Console2", p_open);
}
