...
static inline constexpr auto TestA = "Test";
...
public:
    ...
    void Create() override {
        ...
        BackgroundMusic = Ultra::Audio::Source::LoadFromFile("Assets/Audio/Angels Dream - Aakash Gandhi.ogg");
    ...
    void GuiUpdate() override {
        ...
        */
        ...
        if (selectedNode) {
            ...
            if (ImGui::CollapsingHeader(tag)) {
                ...
                if (ImGui::CollapsingHeader("Transform")) {
                    ImGui::DragFloat3("Size", glm::value_ptr(selectedNode.GetComponent<Component::Transform>().mTransform[1]));
                    ImGui::DragFloat3("Rotation", glm::value_ptr(selectedNode.GetComponent<Component::Transform>().mTransform[2]));
                    ImGui::DragFloat3("Position", glm::value_ptr(selectedNode.GetComponent<Component::Transform>().mTransform[3]));
                }
            }
            ImGui::Separator();
        }
        ...
        if (ImGui::CollapsingHeader("ECS")) {
            ...
            ImGui::DragFloat3("Square Position", glm::value_ptr(SquareEntity.GetComponent<Component::Transform>().mTransform[3]));

            ImGui::DragFloat3("Camera Position", glm::value_ptr(CameraEntity.GetComponent<Component::Transform>().mTransform[3]));

            static bool myCheck = true;
            UI::Property("1st Camera", myCheck);
...

            {
                ...
                if (ImGui::DragFloat("2nd Camera Size", &os, 1.0f, 0.1f, 120.0f)) {
...
private:
    ...
    // ToDo: Since ImGui v.179 it is importand that the size is above zero, otherwize nothing will be visible.
    glm::vec2 ViewportSize = { 1000.0f, 1000.0f };
};
