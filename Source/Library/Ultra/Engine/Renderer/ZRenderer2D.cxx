...
void Renderer2D::Load() {
    // Lines
    {
        ...
        sData.LineIndexBuffer = IndexBuffer::Create(lineIndices, sData.MaxLineIndices * sizeof(uint32_t));
        delete[] lineIndices;
    }
    ...
    // Quads
    {
        ...
        sData.QIndexBuffer = IndexBuffer::Create(quadIndicies, sData.MaxIndices * sizeof(uint32_t));
        delete[] quadIndicies;
    }
